...
public abstract class AbstractLocalizedText : MonoBehaviour {
  ...
  protected string NativeText {
    ...
    set {
      _nativeText = value;
      if (value == null || !HasComponent()) return;
      SetText();
    }
  }

  protected bool HasComponent() => _text;
  ...
  protected virtual void Awake() {
    ...
    if (LanguageManager.Instance != null) {
      LanguageManager.Instance.OnChangeLangauge.AddListener(OnChangeLanguage);
    }
  }
  ...
  void OnDestroy() {
    if (LanguageManager.Instance != null) {
      LanguageManager.Instance.OnChangeLangauge.RemoveListener(OnChangeLanguage);
    }
  }
  ...
  protected virtual void Start() => SetText();
